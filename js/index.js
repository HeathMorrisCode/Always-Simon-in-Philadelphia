...
var app = new Vue({
    ...
    methods: {
            ...
            if (this.playerTurn) {
                if (square == this.pattern[this.counter]) {
                    ...
                    if (this.strict) {
                        ...
                        console.log("You blew it on strict mode, starting from scratch.");
                        this.userConsole = "You blew it on strict mode, starting from scratch.";
                        setTimeout(function () {
                            this.newGame();
                        }.bind(this), 2500);
                    } else {
        ...
        flashSquare: function flashSquare(square) {
        ...
        flashCurrentPattern: function flashCurrentPattern() {
            this.playerTurn = false;
            var i = 0;
